                ...
                <div class="user-dashboard">
					...
					?>
						...
						<div style="padding:40px;">
							<form class="form-horizontal" action='editBook_handler.php' method="POST">
							  <fieldset>
								<div id="legend">
								...
								<div class="control-group col-md-6">
								  ...
								  <div class="controls">
									<input type="text" id="isbn"  value="<?php echo $row['ISBN']; ?>" name="isbn" required class="form-control ">
								...
								<div class="control-group col-md-6">
								  ...
								  <div class="controls">
									<input type="text" id="title"  value="<?php echo $row['title']; ?>" name="title" required class="form-control">
								...
								<div class="control-group col-md-6">
								  ...
								  <div class="controls">
									<input type="text" id="desc" value="<?php echo $row['description']; ?>" name="desc" required class="form-control">
								...
								<div class="control-group col-md-6">
								  ...
								  <div class="controls">
									<input type="text" id="author" value="<?php echo $row['author']; ?>" name="author" required class="form-control">
								...
								<div class="control-group col-md-6">
								  ...
								  <div class="controls">
									<input type="text" id="quantity" value="<?php echo $row['quantity']; ?>" name="quantity" required class="form-control">
								...
								<div class="control-group col-md-6">
								  ...
								  <div class="controls">
									<select required class="form-control" name="boookcat">
										<option value="">Select Book Category</option>
										<?php
											$sql="select * from viewbookcat";
											$stm=$conn->query($sql);
											while($rw=$stm->fetch(PDO::FETCH_ASSOC)){
												if($rw['catID']==$row['category']){
													?>
													<option selected value="<?php  echo $rw['catID']; ?>"> <?php  echo $rw['catName']; ?></option>
													<?php
												}else{
													?>
								...
								<div class="control-group  col-md-10">
								  <!-- Button -->
								  <div class="controls">
									<input class="btn btn-success"  type="submit" name="submit"  value="Update book">
								  </div>
								</div>
							  </fieldset>
							</form>
