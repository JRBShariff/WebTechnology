...
<html lang="en" dir="ltr">
                ...
                <div class="user-dashboard">
					...
					<div class="row" >
						...
						<div style="padding:40px;">
							...
							if(isset($_GET['id'])){
								$id=$_GET['id'];
								$sql="select * from book_cat where catID='$id'";
								$st=$conn->query($sql);
							...
							<form class="form-horizontal" action='' method="POST">
							  <fieldset>
								...
								<div class="control-group col-md-6">
								  ...
								  <div class="controls">
									<input type="text" value="<?php echo $row['catName']; ?>" id="catname" name="catname" required class="form-control">
 ...
 if(isset($_POST['submit'])){
	 $name=$_POST['catname'];
	 $sql="update book_cat set catName=:name where catID=:id"; 
	 $st=$con->prepare($sql);
